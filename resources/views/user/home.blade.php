    ...
    <div class="container">
        <div class="row g-5 align-items-end">
            ...
            <div class="col-lg-6 col-md-7 wow fadeInUp" data-wow-delay="0.3s">
                <h1 class="display-1 text-primary mb-0">{{ $destinasi }}</h1>
    ...
    <div class="container py-5">
        <div class="row g-5">
            <div class="col-sm-6 col-lg-3 text-center wow fadeIn" data-wow-delay="0.1s">
                <h1 class="display-4 text-white" data-toggle="counter-up">{{ $kunjungan->hint_website }}</h1>
                <span class="fs-5 fw-semi-bold text-light">Pengunjung</span>
            </div>
            <div class="col-sm-6 col-lg-3 text-center wow fadeIn" data-wow-delay="0.3s">
                <h1 class="display-4 text-white" data-toggle="counter-up">{{ $destinasi }}</h1>
