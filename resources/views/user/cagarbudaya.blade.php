    ...
    <div class="container">
        <div class="row g-5 align-items-center">
            <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                ...
                <p class="mb-4">
                    Pekalongan memiliki beberapa cagar budaya yang dapat dikunjungi oleh para wisatawan yang tertarik
                    dengan
                    ...
                    <div class="team-text">
                        ...
                        <div class="team-social d-flex">
                            <a class="btn btn-square rounded-circle me-2"
                                href="{{ route('lihat.budaya', $item->slug) }}"><i class="fa fa-link"></i></a>
