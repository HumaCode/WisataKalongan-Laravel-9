    ...
    <div class="container-fluid">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form method="post" action="{{ route('update.cagarbudaya') }}" enctype="multipart/form-data">
                    @csrf

                    <input type="hidden" name="id" value="{{ $budaya->id }}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="nama"
                                    ...
                                    style="border-radius: 0px;" id="nama" value="{{ old('nama', $budaya->nama) }}">
                                @error('nama')
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="slug"
                                    class="form-control form-control-sm @error('slug', $budaya->slug) is-invalid @enderror"
                                    style="border-radius: 0px;" id="slug" readonly
                                    value="{{ old('slug', $budaya->slug) }}">
                                @error('slug')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="alamat"
                                    ...
                                    value="{{ old('alamat', $budaya->alamat) }}">
                                @error('alamat')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <input id="deskripsi" type="hidden" name="deskripsi"
                            value="{{ old('deskripsi', $budaya->deskripsi) }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <img class="img-fluid pad" id="showImage" src="{{ url($budaya->gambar) }}" alt="Photo">
