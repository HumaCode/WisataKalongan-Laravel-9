...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0"> <i class="fas fa-money-bill-alt"></i> &nbsp;{{ $title }}</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Daftar Pemesanan Tiket Masuk</h3>
                ...
                <table id="tabel" class="table table-bordered table-striped projects">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ tanggal_indonesia($item->tgl_order) }}
                            </td>
                            <td class="text-center">
                                <a href="{{ $item->destinasi->lokasi }}" target="_blank" class="badge badge-warning"
                            ...
                            <td class=" text-center">
                                <a href="{{ route('detail.order', $item->id) }}" class="btn bg-cyan btn-sm btn-flat"
                                    data-toggle="tooltip" data-placement="bottom" title="Detail Order"><i
                                        class="fa fa-eye"></i>
                                </a>
